...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
                 process_count, html_safe, expand_templates=True, max_articles=None):
    """
    ...
    for id, revid, title, page in collect_pages(input):
        if max_articles and ordinal >= max_articles:
            break
...
def main():
    ...
    groupS.add_argument("--max-articles", type=int, default=0,
                        help="stop after extracting N articles (0 means no limit)")
    ...
    process_dump(input_file, args.templates, output_path, file_size,
                 ...
                 not args.no_templates, max_articles=max_articles)
